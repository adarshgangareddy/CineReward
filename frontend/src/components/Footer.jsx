      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-16 mb-20">
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-500 text-lg leading-relaxed max-w-sm mb-8 font-medium">
              The next generation of cinema experiences. Watch, Review, and earn
              exclusive rewards in the most active movie community.
            </p>
            <div className="flex space-x-4">
              {[
                {
                  icon: <Instagram />,
                  url: "https://www.instagram.com/zyntri_official?igsh=bTB3ejg0M3NwOWc4",
                },
                {
                  icon: <MessageCircle />,
                  url: "https://chat.whatsapp.com/CKqtVSVs5k22DucoMptaeX?mode=gi_t",
                },
                { icon: <Twitter />, url: "#" },
                {
                  icon: <Github />,
                  url: "https://github.com/AdarshAGangareddy/CineReward",
                },
              ].map((social, i) => (
                <a
                  key={i}
                  ...
                  className="w-12 h-12 bg-slate-900 rounded-2xl flex items-center justify-center text-slate-500 hover:bg-primary hover:text-white transition-all border border-white/5"
                >
                  {social.icon}
                </a>
              ))}
          ...
          <div>
            <h4 className="text-white font-black uppercase tracking-widest text-xs mb-8 underline decoration-primary decoration-4 underline-offset-8">
              Quick Links
            </h4>
          ...
          <div>
            ...
            <div className="space-y-6">
              <a
                href="mailto:zyntri.official@gmail.com"
        ...
        <div className="border-t border-white/5 pt-10 flex flex-col md:flex-row justify-between items-center gap-8">
          <p className="text-slate-600 text-[10px] font-black uppercase tracking-[0.3em] text-center md:text-left">
            © 2026 CineReward. Elite Cinema Platform. Built with ❤️ for the
            community.
          </p>
