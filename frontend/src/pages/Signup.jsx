  ...
  return (
    <div className="flex justify-center items-center min-h-[80vh] px-4 py-12">
      <div className="bg-slate-900 p-10 rounded-3xl border border-slate-800 w-full max-w-md shadow-2xl">
        <h2 className="text-3xl font-black mb-8 text-center text-white italic tracking-tighter uppercase">
          Join <span className="text-primary">CineReward</span>
        </h2>
        ...
        <div className="relative my-8 text-center text-slate-800">
          ...
          <span className="relative px-4 bg-slate-900 text-[10px] font-black uppercase tracking-widest text-slate-600">
            or sign up with
          </span>
        </div>
        ...
        <p className="text-center text-slate-500 text-sm font-medium">
          ...
          <Link
            to="/login"
            className="text-primary hover:underline underline-offset-4 font-bold flex items-center justify-center gap-1 mt-2"
          >
