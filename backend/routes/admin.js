...
router.post(
  ...
  authenticate,
  requireRole("superadmin"),
  adminController.createMovieTeam,
);
router.patch(
  "/teams/:id",
  authenticate,
  requireRole("superadmin"),
  adminController.updateMovieTeam,
);
...
// Movie Team Routes
router.get(
  "/team/dashboard/:movieId",
  authenticate,
  requireRole("movieteam", "superadmin"),
  requireOwnTeamOrSuperadmin,
  movieTeamController.getTeamDashboard,
);
router.post(
  "/team/update-tickets",
  authenticate,
  requireRole("movieteam", "superadmin"),
  requireOwnTeamOrSuperadmin,
  movieTeamController.updateFreeTickets,
);
router.post(
  "/team/select-winners",
  authenticate,
  requireRole("movieteam", "superadmin"),
  requireOwnTeamOrSuperadmin,
  movieTeamController.selectWinners,
);
router.post(
  "/team/award-individual",
  authenticate,
  requireRole("movieteam", "superadmin"),
  requireOwnTeamOrSuperadmin,
  movieTeamController.awardIndividualCoins,
);
...
router.post(
  "/partner/create-payment-order",
  partnerController.createPaymentOrder,
);
...
router.get(
  ...
  authenticate,
  requireRole("superadmin"),
  partnerController.getPaymentHistory,
);
